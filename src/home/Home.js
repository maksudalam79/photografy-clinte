  ...
  return (
    <div>
      <div className="carousel w-full rounded-lg">
        {bannarData.map((bannar) => (
          <BannerItem key={bannar.id} bannar={bannar}></BannerItem>
        ))}
      </div>
      <div>
        <Services></Services>
        <Link to="/allservice">
          <button className="btn btn-ghost mb-2">See All</button>
        </Link>
      </div>
      ...
      {/* <div className="hero min-h-screen bg-base-200">
        <div className="hero-content flex-col lg:flex-row">
          ...
          <div>
            ...
            <p className="py-6">
              "If you can see it, you can shoot it." ...“Photographers don't
              take pictures. ..."Contrast is what makes photography
              interesting." ..."In the world of photography, you get to share a
              captured moment with other people." ..."The camera is an
      ...
      <div className="m-5">
        <h1 className="text-5xl font-bold text-center">Photographer Gallery</h1>
        {services.map((s) => (
          <Gallery key={s._id} s={s}></Gallery>
        ))}
      </div>
      <Contact></Contact>
    </div>
